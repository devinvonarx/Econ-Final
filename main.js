...
var words = [
    ...
    {number:5,direction:'across',row:6,column:15,clue:'Crossword puzzle clues are often given as abreviations or ___ in place of the word that is wanted.',answer:'initials',hint:'https://www.gamesver.com/21-facts-about-crossword-puzzles-you-probably-didnt-know/'},
    ...
    {number:9,direction:'across',row:9,column:14,clue:'The publisher of the first crossword puzzle book was Simon and ___.',answer:'schuster',hint:'https://www.gamesver.com/21-facts-about-crossword-puzzles-you-probably-didnt-know/'},
    ...
    {number:11,direction:'across',row:11,column:17,clue:'Some people find crossword puzzles easy while others find them ___.',answer:'hard',hint:'https://www.gamesver.com/21-facts-about-crossword-puzzles-you-probably-didnt-know/'},
    ...
    {number:16,direction:'across',row:14,column:15,clue:'When in doubt, ___',answer:'guess',hint:'https://www.gamesver.com/21-facts-about-crossword-puzzles-you-probably-didnt-know/'},
    {number:17,direction:'down',row:14,column:17,clue:'The first crossword puzzles were pen and paper. Now many of them are ___.',answer:'electronic',hint:'https://www.gamesver.com/21-facts-about-crossword-puzzles-you-probably-didnt-know/'},
    ...
    {number:19,direction:'down',row:16,column:19,clue:'The first AI computer crossword puzzle solver was named Dr. ___.',answer:'Fill',hint:'https://www.gamesver.com/21-facts-about-crossword-puzzles-you-probably-didnt-know/'},
    {number:20,direction:'down',row:16,column:21,clue:'There is a ___ to the madness of crossword puzzles.',answer:'method',hint:'https://www.gamesver.com/21-facts-about-crossword-puzzles-you-probably-didnt-know/'},
    ...
    {number:21,direction:'down',row:17,column:6,clue:'A mini is a ___ type of crossword puzzle.',answer:'simplified',hint:'https://www.gamesver.com/21-facts-about-crossword-puzzles-you-probably-didnt-know/'},
