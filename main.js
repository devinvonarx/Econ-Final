...
var words = [
    ...
    {number:2,direction:'down',row:2,column:16,clue:'The first online crossword puzzle became available in 199_',answer:'seven',hint:'http://www.angelo.edu/services/ticket_office/softball.php'},
    {number:3,direction:'down',row:3,column:18,clue:'Country where the first crossword puzzle was issued.',answer:'unitedstates',hint:'http://www.angelo.edu/services/specialevents/hhuc.php'},
    ...
    {number:5,direction:'across',row:6,column:15,clue:'Need a clue here',answer:'decoders',hint:'http://myfuture.angelo.edu/content/news/13280-rams-ultimate-frisbee'},
    {number:6,direction:'across',row:7,column:3,clue:'In World War II, British authorities used crossword puzzles to find and recruite people to work as ___.',answer:'decoders',hint:'http://www.angelosports.com/news/2017/5/20/no-1-rambelles-clinch-trip-to-college-softball-world-series-with-6-2-win-over-texas-woman-s.aspx'},
    {number:7,direction:'down',row:7,column:7,clue:'Shape of the first crossword puzzles',answer:'diamond',hint:'http://www.angelo.edu/asu_facts/traditions.php'},
    {number:8,direction:'down',row:9,column:9,clue:'Last name of the creater of the crossword puzzle',answer:'Wynne',hint:'https://youtu.be/VGF4ibgcHQE?t=6s'},
    ...
    {number:10,direction:'down',row:11,column:3,clue:'Current New York Times game editor',answer:'shortz',hint:'http://www.angelo.edu/content/profiles/6250-blue-and-gold'},
    ...
    {number:12,direction:'across',row:13,column:3,clue:'Throw shade was a New York Times crossword puzzle clue in 2017. The allowance of modern slang such as this has been long ___.',answer:'overdue',hint:'http://www.angelo.edu/content/news/13930-asu-goes-clubbing/'},
    {number:13,direction:'down',row:13,column:8,clue:'Crossword puzzles done on a team promote ___',answer:'unity',hint:'http://www.angelo.edu/content/news/15450-ram-rugby-football-club'},
    ...
    {number:15,direction:'down',row:14,column:11,clue:'Most common word in crossword puzzles.',answer:'era',hint:'https://www.angelo.edu/asu_facts/traditions.php'},
    ...
    {number:21,direction:'across',row:17,column:6,clue:'When the code names for beaches in the invasion of Normandy appeared in a crossword puzzle in a British newspaper, Winston Churchhill suspected a ___ ',answer:'spy',hint:'http://www.angelo.edu/president_welcome/presbiography.php'},
    ...
    {number:25,direction:'down',row:20,column:15,clue:'First editor of the New York Times crossword puzzle.',answer:'Farrar',hint:'http://www.angelo.edu/asu_facts/traditions.php'},
